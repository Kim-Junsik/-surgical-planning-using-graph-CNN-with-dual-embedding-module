...
args.num_workers=1
args.shuffle = True
args.save_path = './result_paper_NewLoader/Abs_L2_Adj_backbone_hrnet32_Aug_1024x1024_Tanh_attention_theta0.2_New_distance_2'
...
args.data.root = '/mnt/nas125/forGPU/InHwanKim/data/DentalCeph/snu_move/pre-post/new_datas/papers_data2'#/total_data'
...
args.GCN1.graph="Node_Prediction_GCN"
args.GCN1.num_hidden_blocks = 2
args.GCN1.num_hidden_layers = 1
args.GCN1.n_node = 27
args.GCN1.input_dim = 56#83'56
...
# # GCN2
# args.GCN2 = easydict.EasyDict({})
# args.GCN2.num_hidden_blocks = 2
# args.GCN2.num_hidden_layers = 1
# args.GCN2.n_node = 27
# args.GCN2.input_dim = 160
# args.GCN2.output_dim = 8
# args.GCN2.hidden_dim = [64, 32]
# args.GCN2.pred_dim = [32]

# args.GCN2.activation = "Tanh" # ReLU, Tanh, LeakyReLU
# args.GCN2.act_negative = None
# args.GCN2.is_residual = False # True, False
# args.GCN2.bn = True
# args.GCN2.atn = False
# args.GCN2.num_head = 1 # Attention layer rate
# args.GCN2.dropout = 0 # 0 is dropout False